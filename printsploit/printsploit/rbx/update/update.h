...
inline const uintptr_t Hyperion_Base = (uintptr_t)GetModuleHandleA("RobloxPlayerBeta.dll");
...
namespace offsets {
    ...
    inline constexpr uintptr_t MousePosition = 0xEC; // wtf?
